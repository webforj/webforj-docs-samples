...
public class AppLayoutMobile extends App{
  ...
  @Override
    public void run() throws DwcjException{
      ...
      drawerMenu.setAttribute("placement","bottom");
      drawerMenu.setAttribute("alignment","stretch");
      
      //Adding tabs to drawer menu
      drawerMenu.add("<bbj-icon name='dashboard'></bbj-icon>")
