...
public class IntervalDemo extends App {
    ...
    Button restartInterval = new Button("""
        ...
        //Note: Fractional seconds are allowed to millisecond resolution for an Interval delay//
        float delay = 1f;
        double speedMin = 1;
    ...
    //Creates an array of different icons to loop through on the displayButton during the Interval event//
    String baby = """
        <html>
